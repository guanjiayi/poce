...
from omnisafe.models.actor.gaussian_learning_actor_aug import GaussianLearningActor_AUG
from omnisafe.models.actor.gaussian_sac_actor_aug import GaussianSACActor_AUG
from omnisafe.models.actor.mlp_actor_aug import MLPActor_AUG
from omnisafe.models.actor.perturbation_actor_aug import PerturbationActor_AUG
from omnisafe.models.actor.vae_actor_aug import VAE_AUG
from omnisafe.typing import Activation, ActorType, InitFunction, OmnisafeSpace


# pylint: disable-next=too-few-public-methods
class ActorBuilder_AUG:
    ...
    def build_actor(
    ...
    ) -> GaussianLearningActor_AUG | GaussianSACActor_AUG | MLPActor_AUG | VAE_AUG | PerturbationActor_AUG:
        """Build actor network.
        ...
        if actor_type == 'gaussian_learning':
            return GaussianLearningActor_AUG(
                self._obs_space,
                self._act_space,
                self._hidden_sizes,
