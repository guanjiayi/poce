...
from omnisafe.adapter.offline_adapter_aug import OfflineAdapter_AUG
from omnisafe.algorithms.base_algo import BaseAlgo
from omnisafe.common.logger import Logger
from omnisafe.common.offline.dataset_aug import OfflineDataset_AUG
from omnisafe.models.base_aug import Actor_AUG
from omnisafe.utils.config import Config

from tqdm import tqdm


class BaseOffline_AUG(BaseAlgo):
    ...
    def __init__(self, env_id: str, cfgs: Config) -> None:
        ...
        self._actor: Actor_AUG
        self.epoch: int = 0
        self._step: int = 0

    def _init(self) -> None:
        self._dataset = OfflineDataset_AUG(
    ...
    def _init_env(self) -> None:
        self._env = OfflineAdapter_AUG(self._env_id, self._seed, self._cfgs)
    ...
    def learn(self) -> tuple[float, float, float]:
        ...
        for step in tqdm(range(self._cfgs.train_cfgs.total_steps)):
            ...
            if (step + 1) % self._cfgs.train_cfgs.eval_freq == 0:
    ...
    def _evaluate(self) -> None:
        """Evaluate the model."""
        self._env.evaluate_baseline_bcq(
