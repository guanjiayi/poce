...
from omnisafe.algorithms.offline.base_aug import BaseOffline_AUG
...
@registry.register
class POCE_CORE(BaseOffline_AUG):
    ...
    def _init_model(self) -> None:
        ...
        # )
        self._reward_critic_optimizer1 = optim.Adam(
            self._reward_critic.critic_0.parameters(),
            lr=self._cfgs.model_cfgs.critic.lr,
        )
        self._reward_critic_optimizer2 = optim.Adam(
